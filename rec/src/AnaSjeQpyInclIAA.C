...
const TString srcName = "AnaSjeQpyInclIAA";
//=============================================================================
...
//=============================================================================
  ...
  TNtuple *nt = new TNtuple("nt", "", "fWgt:kXsc:fLje:fLjr:fLtk:fLtr:fJet:fAje:fMje:f1sj:f1sA:f1sm:f1sr:f2sj:f2sA:f2sm:f2sr:fDsm:fDsr");
//=============================================================================
