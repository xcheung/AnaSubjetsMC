...
//=============================================================================
  ...
  TH2D *h5py81 = (TH2D*)file->Get("hJet1sz"); h5py81->SetName("h5py81"); h5py81->SetDirectory(0);
  TH2D *h5py82 = (TH2D*)file->Get("hJet2sz"); h5py82->SetName("h5py82"); h5py82->SetDirectory(0);
  file->Close();

  file = TFile::Open("data/incl/AnalysisOutputs_jet_qpy_JetR05_SjeR01.root", "READ");
  TH2D *h5qpy1 = (TH2D*)file->Get("hJet1sz"); h5qpy1->SetName("h5qpy1"); h5qpy1->SetDirectory(0);
  TH2D *h5qpy2 = (TH2D*)file->Get("hJet2sz"); h5qpy2->SetName("h5qpy2"); h5qpy2->SetDirectory(0);
  file->Close();

  file = TFile::Open("data/incl/AnalysisOutputs_jet_med_JetR05_SjeR01.root", "READ");
  TH2D *h5med1 = (TH2D*)file->Get("hJet1sz"); h5med1->SetName("h5med1"); h5med1->SetDirectory(0);
  TH2D *h5med2 = (TH2D*)file->Get("hJet2sz"); h5med2->SetName("h5med2"); h5med2->SetDirectory(0);
  file->Close();


  file = TFile::Open("data/incl/AnalysisOutputs_jet_py8_JetR04_SjeR01.root", "READ");
  TH2D *h4py81 = (TH2D*)file->Get("hJet1sz"); h4py81->SetName("h4py81"); h4py81->SetDirectory(0);
  TH2D *h4py82 = (TH2D*)file->Get("hJet2sz"); h4py82->SetName("h4py82"); h4py82->SetDirectory(0);
  file->Close();

  file = TFile::Open("data/incl/AnalysisOutputs_jet_qpy_JetR04_SjeR01.root", "READ");
  TH2D *h4qpy1 = (TH2D*)file->Get("hJet1sz"); h4qpy1->SetName("h4qpy1"); h4qpy1->SetDirectory(0);
  TH2D *h4qpy2 = (TH2D*)file->Get("hJet2sz"); h4qpy2->SetName("h4qpy2"); h4qpy2->SetDirectory(0);
  file->Close();

  file = TFile::Open("data/incl/AnalysisOutputs_jet_med_JetR04_SjeR01.root", "READ");
  TH2D *h4med1 = (TH2D*)file->Get("hJet1sz"); h4med1->SetName("h4med1"); h4med1->SetDirectory(0);
  TH2D *h4med2 = (TH2D*)file->Get("hJet2sz"); h4med2->SetName("h4med2"); h4med2->SetDirectory(0);
  file->Close();
//=============================================================================
...
//=============================================================================
  ...
  can = MakeCanvas("Jet5XszMean"); can->SetGridx(); can->SetGridy();
...
//=============================================================================
  ...
  can = MakeCanvas("Jet4XszMean"); can->SetGridx(); can->SetGridy();
  hfm = can->DrawFrame(0., 0., 400., 1.2); SetupFrame(hfm, dlsx, dlsy, dtsx, dtsy, dtox, dtoy,
                                                       "#it{p}_{T,jet} (GeV/#it{c})",
                                                       "<#it{z}_{sj}>");
  hfm->GetXaxis()->SetNdivisions(510);
