...
//=============================================================================
  ...
  TH2D *h5py81 = (TH2D*)file->Get("hJet1fr"); h5py81->SetName("h5py81"); h5py81->SetDirectory(0);
  TH2D *h5py82 = (TH2D*)file->Get("hJet2fr"); h5py82->SetName("h5py82"); h5py82->SetDirectory(0);
  file->Close();

  file = TFile::Open("data/mass/AnalysisOutputs_Dsm_qpy_JetR05_SjeR01.root", "READ");
  TH2D *h5qpy1 = (TH2D*)file->Get("hJet1fr"); h5qpy1->SetName("h5qpy1"); h5qpy1->SetDirectory(0);
  TH2D *h5qpy2 = (TH2D*)file->Get("hJet2fr"); h5qpy2->SetName("h5qpy2"); h5qpy2->SetDirectory(0);
  file->Close();

  file = TFile::Open("data/mass/AnalysisOutputs_Dsm_med_JetR05_SjeR01.root", "READ");
  TH2D *h5med1 = (TH2D*)file->Get("hJet1fr"); h5med1->SetName("h5med1"); h5med1->SetDirectory(0);
  TH2D *h5med2 = (TH2D*)file->Get("hJet2fr"); h5med2->SetName("h5med2"); h5med2->SetDirectory(0);
  file->Close();


  file = TFile::Open("data/mass/AnalysisOutputs_Dsm_py8_JetR04_SjeR01.root", "READ");
  TH2D *h4py81 = (TH2D*)file->Get("hJet1fr"); h4py81->SetName("h4py81"); h4py81->SetDirectory(0);
  TH2D *h4py82 = (TH2D*)file->Get("hJet2fr"); h4py82->SetName("h4py82"); h4py82->SetDirectory(0);
  file->Close();

  file = TFile::Open("data/mass/AnalysisOutputs_Dsm_qpy_JetR04_SjeR01.root", "READ");
  TH2D *h4qpy1 = (TH2D*)file->Get("hJet1fr"); h4qpy1->SetName("h4qpy1"); h4qpy1->SetDirectory(0);
  TH2D *h4qpy2 = (TH2D*)file->Get("hJet2fr"); h4qpy2->SetName("h4qpy2"); h4qpy2->SetDirectory(0);
  file->Close();

  file = TFile::Open("data/mass/AnalysisOutputs_Dsm_med_JetR04_SjeR01.root", "READ");
  TH2D *h4med1 = (TH2D*)file->Get("hJet1fr"); h4med1->SetName("h4med1"); h4med1->SetDirectory(0);
  TH2D *h4med2 = (TH2D*)file->Get("hJet2fr"); h4med2->SetName("h4med2"); h4med2->SetDirectory(0);
  file->Close();
//=============================================================================
...
//=============================================================================
  ...
  const TString stny = "<#it{R}(sj,jet)>";
...
//=============================================================================
  ...
  can = MakeCanvas("Jet5XfrMean"); can->SetGridx(); can->SetGridy();
...
//=============================================================================
  ...
  can = MakeCanvas("Jet4XfrMean"); can->SetGridx(); can->SetGridy();
  hfm = can->DrawFrame(dflx, dfly, dfux, dfuy); SetupFrame(hfm, dlsx, dlsy, dtsx, dtsy, dtox, dtoy, stnx, stny);
  hfm->GetXaxis()->SetNdivisions(510);
  hfm->GetYaxis()->SetNdivisions(510);
