...
//=============================================================================
  ...
  TH2D *hJetPtEtaVac = (TH2D*)file->Get("hJe2PtPhi"); hJetPtEtaVac->SetName("hJetPtEtaVac"); hJetPtEtaVac->SetDirectory(0);
  TH2D *hLjePtEtaVac = (TH2D*)file->Get("hLj2PtPhi"); hLjePtEtaVac->SetName("hLjePtEtaVac"); hLjePtEtaVac->SetDirectory(0);
  TH2D *hNjePtEtaVac = (TH2D*)file->Get("hNj2PtPhi"); hNjePtEtaVac->SetName("hNjePtEtaVac"); hNjePtEtaVac->SetDirectory(0);
  file->Close();

  file = TFile::Open("data/AnalysisResults_med_JetR05_skTR01.root", "READ");
  TH2D *hJetPtEtaMed = (TH2D*)file->Get("hJe2PtPhi"); hJetPtEtaMed->SetName("hJetPtEtaMed"); hJetPtEtaMed->SetDirectory(0);
  TH2D *hLjePtEtaMed = (TH2D*)file->Get("hLj2PtPhi"); hLjePtEtaMed->SetName("hLjePtEtaMed"); hLjePtEtaMed->SetDirectory(0);
  TH2D *hNjePtEtaMed = (TH2D*)file->Get("hNj2PtPhi"); hNjePtEtaMed->SetName("hNjePtEtaMed"); hNjePtEtaMed->SetDirectory(0);
  file->Close();
//=============================================================================
...
//=============================================================================
  ...
  const Float_t dflx = -1., dfux = 1.;
  const Float_t dfly = 0., dfuy = 10.;

  const Float_t dlsx = 0.05, dlsy = 0.05;
  const Float_t dtsx = 0.06, dtsy = 0.06;
  const Float_t dtox = 1.10, dtoy = 1.00;

  const TString stnx = "cos(#varphi_{jet})";
...
//=============================================================================
  ...
  can = MakeCanvas("Je2PhiVac"); can->SetGridx(); can->SetGridy();
  ...
  tex->DrawLatex(0.16, 0.84, "Jet: anti-#it{k}_{T}, #it{R}=0.5, |#eta_{jet}|<2, #it{N}_{sj}#geq2");
  CanvasEnd(can);
//=============================================================================

  can = MakeCanvas("Je2PhiMed"); can->SetGridx(); can->SetGridy();
  hfm = can->DrawFrame(dflx, dfly, dfux, dfuy); SetupFrame(hfm, dlsx, dlsy, dtsx, dtsy, dtox, dtoy, stnx, stny);
  hfm->GetXaxis()->SetNdivisions(510);
  hfm->GetYaxis()->SetNdivisions(510);
