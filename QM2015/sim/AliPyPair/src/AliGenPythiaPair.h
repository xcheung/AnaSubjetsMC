...
/* $Id: AliGenPythiaPair.h 63851 2013-08-14 07:58:44Z morsch $ */
...
class AliGenPythiaPair : public AliGenMC
{
 public:
    ...
    AliGenPythiaPair();
    AliGenPythiaPair(Int_t npart);
    virtual ~AliGenPythiaPair();
...
//=============================================================================
//=============================================================================
  void SetUserDebug(Bool_t b) { fUserDebug = b; }

  void SetGenPartonNumber   (Int_t n) { fGenPartonNumber = n; }
  void SetGenPartonFlavor   (Int_t n) { fGenPartonFlavor = n; }
  void SetGenPartonEnergy(Double_t d) { fGenPartonEnergy = d; }

  void SetIsGenPartonPair(Bool_t b) { fIsGenPartonPair = b; }
  void SetIsGenUnsignEta (Bool_t b) { fIsGenUnsignEta  = b; }

  void SetGenSigmaEta(Double_t d) { fGenSigmaEta = d; }
  void SetGenSigmaPhi(Double_t d) { fGenSigmaPhi = d; }

  void SetIsGenFixedEta(Bool_t b) { fIsGenFixedEta = b; }
  void SetIsGenFixedPhi(Bool_t b) { fIsGenFixedPhi = b; }

  void SetGenPartonEtaRange(Double_t dMin, Double_t dMax) { fGenPartonEtaMin = dMin; fGenPartonEtaMax = dMax; }
  void SetGenPartonPhiRange(Double_t dMin, Double_t dMax) { fGenPartonPhiMin = dMin; fGenPartonPhiMax = dMax; }
//=============================================================================
//=============================================================================
 ...
 protected:
    ...
    Int_t  fProcDiff;
 private:
    AliGenPythiaPair(const AliGenPythiaPair &Pythia);
    AliGenPythiaPair & operator=(const AliGenPythiaPair & rhs);
...
//=============================================================================
  ...
  Double_t CovEtaToTheta(Double_t dy);
  Double_t CovThetaToEta(Double_t dt);

  Bool_t fUserDebug;

  Int_t    fGenPartonNumber;
  Int_t    fGenPartonFlavor;
  Double_t fGenPartonEnergy;

  Bool_t   fIsGenPartonPair;
  Bool_t   fIsGenUnsignEta;

  Double_t fGenSigmaEta;
  Bool_t   fIsGenFixedEta;

  Double_t fGenPartonEtaMin;
  Double_t fGenPartonEtaMax;

  Double_t fGenSigmaPhi;
  Bool_t   fIsGenFixedPhi;

  Double_t fGenPartonPhiMin;
  Double_t fGenPartonPhiMax;
//=============================================================================
//=============================================================================

    ClassDef(AliGenPythiaPair, 15) // AliGenerator interface to Pythia
};
#endif
