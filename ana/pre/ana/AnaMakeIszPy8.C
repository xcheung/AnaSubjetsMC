void AnaMakeIszPy8(const TString sPref,
                   const TString sPath,
                   const TString sHist="hJetIsz")
{
...
//=============================================================================
  ...
  TH2D *hist2 = GetHist2Py8(sHist, Form("%s/%s",sPath.Data(),sPref.Data()));
...
//=============================================================================
  ...
  list->Print();
  TFile *file = TFile::Open("AnalysisOutputs_Isz.root", "UPDATE");
