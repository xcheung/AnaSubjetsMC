...
//=============================================================================
  ...
  TH2D *h5py8 = (TH2D*)file->Get("hJet2sz"); h5py8->SetName("h5py8"); h5py8->SetDirectory(0);
  file->Close();

  file = TFile::Open("data/incl/AnalysisOutputs_jet_qpy_JetR05_SjeR01.root", "READ");
  TH2D *h5qpy = (TH2D*)file->Get("hJet2sz"); h5qpy->SetName("h5qpy"); h5qpy->SetDirectory(0);
  file->Close();

  file = TFile::Open("data/incl/AnalysisOutputs_jet_med_JetR05_SjeR01.root", "READ");
  TH2D *h5med = (TH2D*)file->Get("hJet2sz"); h5med->SetName("h5med"); h5med->SetDirectory(0);
  file->Close();


  file = TFile::Open("data/incl/AnalysisOutputs_jet_py8_JetR04_SjeR01.root", "READ");
  TH2D *h4py8 = (TH2D*)file->Get("hJet2sz"); h4py8->SetName("h4py8"); h4py8->SetDirectory(0);
  file->Close();

  file = TFile::Open("data/incl/AnalysisOutputs_jet_qpy_JetR04_SjeR01.root", "READ");
  TH2D *h4qpy = (TH2D*)file->Get("hJet2sz"); h4qpy->SetName("h4qpy"); h4qpy->SetDirectory(0);
  file->Close();

  file = TFile::Open("data/incl/AnalysisOutputs_jet_med_JetR04_SjeR01.root", "READ");
  TH2D *h4med = (TH2D*)file->Get("hJet2sz"); h4med->SetName("h4med"); h4med->SetDirectory(0);
  file->Close();
//=============================================================================
...
//=============================================================================
  ...
  can = MakeCanvas("Jet5py82szCorr"); can->SetGridx(); can->SetGridy(); can->SetLogz();
  can->SetTopMargin(0.1); can->SetRightMargin(0.1);
  hfm = can->DrawFrame(0., 0., 400., 0.5); SetupFrame(hfm, dlsx, dlsy, dtsx, dtsy, dtox, dtoy,
                                                       "#it{p}_{T,jet} (GeV/#it{c})",
                                                       "#it{z}_{sj}^{2nd} =  #it{p}_{T,sub-jet}^{2nd leading} / #it{p}_{T,jet}");
...
//=============================================================================
  ...
  can = MakeCanvas("Jet5qpy2szCorr"); can->SetGridx(); can->SetGridy(); can->SetLogz();
  can->SetTopMargin(0.1); can->SetRightMargin(0.1);
  hfm = can->DrawFrame(0., 0., 400., 0.5); SetupFrame(hfm, dlsx, dlsy, dtsx, dtsy, dtox, dtoy,
                                                       "#it{p}_{T,jet} (GeV/#it{c})",
                                                       "#it{z}_{sj}^{2nd} =  #it{p}_{T,sub-jet}^{2nd leading} / #it{p}_{T,jet}");
...
//=============================================================================
  ...
  can = MakeCanvas("Jet5med2szCorr"); can->SetGridx(); can->SetGridy(); can->SetLogz();
  can->SetTopMargin(0.1); can->SetRightMargin(0.1);
  hfm = can->DrawFrame(0., 0., 400., 0.5); SetupFrame(hfm, dlsx, dlsy, dtsx, dtsy, dtox, dtoy,
                                                       "#it{p}_{T,jet} (GeV/#it{c})",
                                                       "#it{z}_{sj}^{2nd} =  #it{p}_{T,sub-jet}^{2nd leading} / #it{p}_{T,jet}");
...
//=============================================================================
  ...
  can = MakeCanvas("Jet4py82szCorr"); can->SetGridx(); can->SetGridy(); can->SetLogz();
  can->SetTopMargin(0.1); can->SetRightMargin(0.1);
  hfm = can->DrawFrame(0., 0., 400., 0.5); SetupFrame(hfm, dlsx, dlsy, dtsx, dtsy, dtox, dtoy,
                                                       "#it{p}_{T,jet} (GeV/#it{c})",
                                                       "#it{z}_{sj}^{2nd} =  #it{p}_{T,sub-jet}^{2nd leading} / #it{p}_{T,jet}");
...
//=============================================================================
  ...
  can = MakeCanvas("Jet4qpy2szCorr"); can->SetGridx(); can->SetGridy(); can->SetLogz();
  can->SetTopMargin(0.1); can->SetRightMargin(0.1);
  hfm = can->DrawFrame(0., 0., 400., 0.5); SetupFrame(hfm, dlsx, dlsy, dtsx, dtsy, dtox, dtoy,
                                                       "#it{p}_{T,jet} (GeV/#it{c})",
                                                       "#it{z}_{sj}^{2nd} =  #it{p}_{T,sub-jet}^{2nd leading} / #it{p}_{T,jet}");
...
//=============================================================================
  ...
  can = MakeCanvas("Jet4med2szCorr"); can->SetGridx(); can->SetGridy(); can->SetLogz();
  can->SetTopMargin(0.1); can->SetRightMargin(0.1);
  hfm = can->DrawFrame(0., 0., 400., 0.5); SetupFrame(hfm, dlsx, dlsy, dtsx, dtsy, dtox, dtoy,
                                                       "#it{p}_{T,jet} (GeV/#it{c})",
                                                       "#it{z}_{sj}^{2nd} =  #it{p}_{T,sub-jet}^{2nd leading} / #it{p}_{T,jet}");
