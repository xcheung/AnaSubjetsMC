void PlotDszR05Reco()
{
  ...
  const TString sTag = "#it{p}_{T,jet}^{Trigger}>120 GeV/#it{c}";
//=============================================================================

  TFile *file = TFile::Open("data/incl/AnalysisOutputs_Rje_py8_JetR05_SjeR01.root", "READ");
  TH2D *hpy8 = (TH2D*)file->Get("hJetDszj120"); hpy8->SetName("hpy8"); hpy8->SetDirectory(0);
  file->Close();

  file = TFile::Open("data/incl/AnalysisOutputs_Rje_qpy_JetR05_SjeR01.root", "READ");
  TH2D *hqpy = (TH2D*)file->Get("hJetDszj120"); hqpy->SetName("hqpy"); hqpy->SetDirectory(0);
  file->Close();

  file = TFile::Open("data/incl/AnalysisOutputs_Rje_med_JetR05_SjeR01.root", "READ");
  TH2D *hmed = (TH2D*)file->Get("hJetDszj120"); hmed->SetName("hmed"); hmed->SetDirectory(0);
  file->Close();
//=============================================================================
