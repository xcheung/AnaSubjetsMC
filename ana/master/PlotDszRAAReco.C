...
//=============================================================================
  ...
  file = TFile::Open("data/incl/AnalysisOutputs_Rje_py6_JetR05_SjeR01.root", "READ");
  TH2D *h5py6 = (TH2D*)file->Get("hJetDszt020"); h5py6->SetName("h5py6"); h5py6->SetDirectory(0);
  file->Close();

  file = TFile::Open("data/incl/AnalysisOutputs_Rje_qpy_JetR05_SjeR01.root", "READ");
  TH2D *h5qpy = (TH2D*)file->Get("hJetDszt020"); h5qpy->SetName("h5qpy"); h5qpy->SetDirectory(0);
  file->Close();

  file = TFile::Open("data/incl/AnalysisOutputs_Rje_vac_JetR05_SjeR01.root", "READ");
  TH2D *h5vac = (TH2D*)file->Get("hJetDszt020"); h5vac->SetName("h5vac"); h5vac->SetDirectory(0);
  file->Close();

  file = TFile::Open("data/incl/AnalysisOutputs_Rje_med_JetR05_SjeR01.root", "READ");
  TH2D *h5med = (TH2D*)file->Get("hJetDszt020"); h5med->SetName("h5med"); h5med->SetDirectory(0);
  file->Close();


  file = TFile::Open("data/incl/AnalysisOutputs_Rje_py6_JetR04_SjeR01.root", "READ");
  TH2D *h4py6 = (TH2D*)file->Get("hJetDszt020"); h4py6->SetName("h4py6"); h4py6->SetDirectory(0);
  file->Close();

  file = TFile::Open("data/incl/AnalysisOutputs_Rje_qpy_JetR04_SjeR01.root", "READ");
  TH2D *h4qpy = (TH2D*)file->Get("hJetDszt020"); h4qpy->SetName("h4qpy"); h4qpy->SetDirectory(0);
  file->Close();

  file = TFile::Open("data/incl/AnalysisOutputs_Rje_vac_JetR04_SjeR01.root", "READ");
  TH2D *h4vac = (TH2D*)file->Get("hJetDszt020"); h4vac->SetName("h4vac"); h4vac->SetDirectory(0);
  file->Close();

  file = TFile::Open("data/incl/AnalysisOutputs_Rje_med_JetR04_SjeR01.root", "READ");
  TH2D *h4med = (TH2D*)file->Get("hJetDszt020"); h4med->SetName("h4med"); h4med->SetDirectory(0);
  file->Close();
//=============================================================================
